 ...
 * funções de ordenação e busca são genéricas para qualquer tipo de vetor e 
 * a função readline funciona para qualquer FILE *.
 */
...
// Lê uma linha alocada dinâmicamente de algum arquivo (ou stdin, stdout, etc).
